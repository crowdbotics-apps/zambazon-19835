"""zambazon_19835 URL Configuration
...
admin.site.site_header = "Zambazon"
admin.site.site_title = "Zambazon Admin Portal"
admin.site.index_title = "Zambazon Admin"

# swagger
api_info = openapi.Info(
    title="Zambazon API",
    default_version="v1",
    description="API documentation for Zambazon App",
)
